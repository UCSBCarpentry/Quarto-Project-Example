...
Nitsch, F. J., Sellitto, M., & Kalenscher, T. (2021). Trier social stress test and food-choice: Behavioral, self-report & hormonal data. *Data in brief*, *37*, 107245. [<https://doi.org/10.1016/j.dib.2021.107245>](https://doi.org/10.1016/j.dib.2021.107245 "Persistent link using digital object identifier")
...
![Fig. 1 provides an exact overview of the experimental timeline for each measure we collected. All experimental sessions took place from 3 p.m. to 6 p.m. to control for circadian variations of hormonal levels. Participants were assigned to the two experimental conditions pseudo-randomly.](./fig/Fig1.jpg "Fig. 1. Experimental timeline and measurements.")
...
FIXME add Fig 3 Fig 3: Mean heart rate of stress and control groups at baseline and during intervention.

```{r fig3-heartrate, fig.cap="Fig 3: Mean heart rate of stress and control groups at baseline and during intervention."}
library(tidyverse)
library(BayesFactor)
...
```{r fig4-cortisol-amylase, fig.cap = "Fig 4: Cortisol and Amylase levels in stress and control groups" }
...
All analyses were conducted in R[^1] in the RStudio IDE[^2] using the packages Tidyverse @wickham2019, stringi[^3], BayesFactor[^4] and patchwork[^5].
