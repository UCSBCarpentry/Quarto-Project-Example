...
Fig 4: Cortisol and Amylase levels in stress and control groups

```{r,  echo=FALSE, warning = FALSE, message = FALSE, include=TRUE}
source("./code/05_CCEI_analysis.R", local = knitr::knit_global())
# or
#sys.source("./code/02_hormone_analysis.R", envir = knitr::knit_global())
#knitr::read_chunk('./code/05_CCEI_analysis.r')
# code = readLines("./code/05_CCEI_analysis.r"),
plot
```
